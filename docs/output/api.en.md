...
Kernel builder functions for Finite Volume Method operators. These build kernel descriptions only — no computation is performed.
...
Time integration and operator splitting method orchestration.
